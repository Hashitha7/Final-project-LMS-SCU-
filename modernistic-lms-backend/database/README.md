# 🗄️ Modernistic LMS - MySQL Database Setup Guide
...
3. Verify: You should see "Database Modernistic LMS_hub created successfully!"
...
# Run the scripts
source C:/Users/User/Downloads/New folder/New folder (2)/Modernistic LMS-hub-backend/database/01_create_database.sql
source C:/Users/User/Downloads/New folder/New folder (2)/Modernistic LMS-hub-backend/database/02_create_tables.sql
source C:/Users/User/Downloads/New folder/New folder (2)/Modernistic LMS-hub-backend/database/03_insert_sample_data.sql
```
...
- **Database Name:** `Modernistic LMS_hub`
- **Host:** `localhost`
- **Port:** `3306`
- **Username:** `root`
...
2. **Run Spring Boot Application:**
   ```bash
   cd Modernistic LMS-hub-backend
   mvn spring-boot:run
   ```
...
| Email | Password | Role |
|-------|----------|------|
| admin@Modernistic LMS.com | demo123 | ADMIN |
| james@Modernistic LMS.com | demo123 | TEACHER |
| sarah@Modernistic LMS.com | demo123 | TEACHER |
| alex@Modernistic LMS.com | demo123 | STUDENT |
| emma@Modernistic LMS.com | demo123 | STUDENT |
| michael@Modernistic LMS.com | demo123 | STUDENT |
...
### Error: "Unknown database 'Modernistic LMS_hub'"
...
-- Use Modernistic LMS_hub database
USE Modernistic LMS_hub;
...
DROP DATABASE Modernistic LMS_hub;
```
